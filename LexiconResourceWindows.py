...
class HebrewLexiconResourceFrame( ResourceFrame ):
    ...
    def update( self ): # Leaves in disabled state
        def displayVerse( firstFlag, BnCV, verseDataList, currentVerse=False ):
            #print( "HebrewLexiconResourceFrame.displayVerse", firstFlag, BnCV, [], currentVerse )
            haveC = None
...
class GreekLexiconResourceFrame( ResourceFrame ):
    ...
    def update( self ): # Leaves in disabled state
        def displayVerse( firstFlag, BnCV, verseDataList, currentVerse=False ):
            #print( "GreekLexiconResourceFrame.displayVerse", firstFlag, BnCV, [], currentVerse )
            haveC = None
            lastCharWasSpace = haveTextFlag = not firstFlag
            if verseDataList is None:
                print( "  ", BnCV, "has no data" )
...
class BibleLexiconResourceFrame( ResourceFrame ):
    ...
    def update( self ): # Leaves in disabled state
        def displayVerse( firstFlag, BnCV, verseDataList, currentVerse=False ):
            #print( "BibleLexiconResourceFrame.displayVerse", firstFlag, BnCV, [], currentVerse )
            haveC = None
            lastCharWasSpace = haveTextFlag = not firstFlag
            if verseDataList is None:
                print( "  ", BnCV, "has no data" )
