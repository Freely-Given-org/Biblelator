...
class BOSManager( Frame ):
    ...
    def __init__( self, rootWindow, homeFolderpath, loggingFolderpath, iconImage, settings ):
        ...
        """
        fnPrint( DEBUGGING_THIS_MODULE, "BOSManager.__init__( {}, {}, {}, … )".format( rootWindow, homeFolderpath, loggingFolderpath ) )
    ...
    def gotoNewVersification( self, event=None ):
        ...
        dPrint( 'Verbose', DEBUGGING_THIS_MODULE, "vers cursel", repr(self.versificationsListbox.curselection()) )
    ...
    def gotoNewName( self, event=None ):
        ...
        dPrint( 'Verbose', DEBUGGING_THIS_MODULE, "name cursel", repr(self.namesListbox.curselection()) )
    ...
    def searchStylesheet( self, event ):
        ...
        if len(enteredText)<3: self.setErrorStatus( "Books stylesheets must be at least three characters" ); return
            ...
            self.setErrorStatus( _("Unknown {!r} book stylesheet").format( enteredText ) )
            return
    ...
    def doGotoInfo( self, event=None ):
        ...
        """
        fnPrint( DEBUGGING_THIS_MODULE, "BOSManager.doGotoInfo( {} )".format( event ) )
    ...
    def doCloseMyChildWindows( self ):
        ...
        """
        fnPrint( DEBUGGING_THIS_MODULE, "BOSManager.doCloseMyChildWindows()" )
    ...
    def doCloseMe( self ):
        ...
        """
        fnPrint( DEBUGGING_THIS_MODULE, "BOSManager.doCloseMe()" )
...
def openBOSManager( parent ):
    ...
    """
    if BibleOrgSysGlobals.debugFlag and DEBUGGING_THIS_MODULE:
        vPrint( 'Quiet', DEBUGGING_THIS_MODULE, _("BOSManager.openBOSManager( {} )").format( parent ) )
