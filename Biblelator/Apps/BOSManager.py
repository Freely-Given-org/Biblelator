...
class BOSManager( Frame ):
    ...
    def __init__( self, rootWindow, homeFolderpath, loggingFolderpath, iconImage, settings ):
        ...
        """
        fnPrint( debuggingThisModule, "BOSManager.__init__( {}, {}, {}, … )".format( rootWindow, homeFolderpath, loggingFolderpath ) )
    ...
    def gotoNewVersification( self, event=None ):
        ...
        dPrint( 'Verbose', debuggingThisModule, "vers cursel", repr(self.versificationsListbox.curselection()) )
    ...
    def gotoNewName( self, event=None ):
        ...
        dPrint( 'Verbose', debuggingThisModule, "name cursel", repr(self.namesListbox.curselection()) )
    ...
    def doGotoInfo( self, event=None ):
        ...
        """
        fnPrint( debuggingThisModule, "BOSManager.doGotoInfo( {} )".format( event ) )
    ...
    def doCloseMyChildWindows( self ):
        ...
        """
        fnPrint( debuggingThisModule, "BOSManager.doCloseMyChildWindows()" )
    ...
    def doCloseMe( self ):
        ...
        """
        fnPrint( debuggingThisModule, "BOSManager.doCloseMe()" )
