...
ShortProgName = "EditFrames"
ProgName = "Biblelator Edit Frames"
ProgVersion = "0.15"
...
from BibleResourceFrames import InternalBibleResourceFrame
...
class USFMEditFrame( InternalBibleResourceFrame ):
    def __init__( self, parent, master, modulePath, editMode ):
        ...
        if self.InternalBible is not None:
            ...
            self.USFMEditFrameParent.title( "[{}] {} ({}) Editable".format( self.resourceWindowParent.groupCode, self.InternalBible.name, self.editMode, self.resourceWindowParent.contextViewMode ) )
    ...
    def refreshTitle( self ):
        self.USFMEditFrameParent.title( "[{}] {} ({}) Editable {}".format( self.resourceWindowParent.groupCode,
                                    self.InternalBible.name if self.InternalBible is not None else 'None',
                                    self.editMode, self.resourceWindowParent.contextViewMode ) )
